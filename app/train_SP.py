# sudo docker-compose exec app python3 train_SP.py -r -e tictactoe -tt 2e7 -t 0.5 -tn 4
...
def main(threadID, args):
    ...
    logger.info(f'\n+++Thread {threadID}+++ Setting up the selfplay training environment opponents...')
